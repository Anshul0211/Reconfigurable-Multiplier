...
set_attr hdl_search_path      /home/zaqi/Project_2026_final/{folder_name}/rtl #Enter folder name here
...
# Step 2: Read HDL
# ============================================================
read_hdl -sv {reconfig_fp_top.sv} #replace reconfig_fp_top with the top module name
...
set precision_cases {
    ...
    {8   4   fp_8_4.vcd    "8b_4e"} #replace fp_8_4 with the vcd file name
