...
# Generated on: Tue Apr 07 16:02:15 EDT 2026 (Tue Apr 07 20:02:15 UTC 2026)
...
set logfile fv/reconfig_fp_top/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/reconfig_fp_top -revised fv_map
...
add_search_path /home/zaqi/Project_2026_final/AlexNet_config1/rtl -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  /home/zaqi/Project_2026_final/AlexNet_config1/rtl/reconfig_fp_top.sv
elaborate_design -golden -root {reconfig_fp_top} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/reconfig_fp_top/fv_map.v.gz
elaborate_design -revised -root {reconfig_fp_top}
...
#add_name_alias fv/reconfig_fp_top/fv_map.singlebit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.reconfig_fp_top.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.reconfig_fp_top.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.reconfig_fp_top.rtl.fv_map.rpt
