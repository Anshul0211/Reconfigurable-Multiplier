...
# Generated on: Thu Apr 16 13:57:25 EDT 2026 (Thu Apr 16 17:57:25 UTC 2026)
...
set logfile fv/fp16_multiplier_pipe/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/fp16_multiplier_pipe -revised fv_map
...
add_search_path /home/zaqi/DECODER_ZAQI/lib -library -both
read_library -liberty -both \
    /home/zaqi/DECODER_ZAQI/lib/uk65lscllmvbbr_120c25_tc_ccs.lib
...
add_search_path /home/zaqi/Project_2026_final/FP16_base/rtl -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  /home/zaqi/Project_2026_final/FP16_base/rtl/fp16_multiplier_pipe.sv
elaborate_design -golden -root {fp16_multiplier_pipe} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/fp16_multiplier_pipe/fv_map.v.gz
elaborate_design -revised -root {fp16_multiplier_pipe}
...
#add_name_alias fv/fp16_multiplier_pipe/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.fp16_multiplier_pipe.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.fp16_multiplier_pipe.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.fp16_multiplier_pipe.rtl.fv_map.rpt
